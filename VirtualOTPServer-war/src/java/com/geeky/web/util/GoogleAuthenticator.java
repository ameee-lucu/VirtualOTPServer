...
public class GoogleAuthenticator {
	...
	public static String getQRBarcodeURL(String secret) {
        String format ="http://chart.apis.google.com/chart?cht=qr&chs=230x230&chld=L&choe=UTF-8&chl="+secret;
		//String format = "https://www.google.com/chart?chs=150x150&chld=M%%7C0&cht=qr&chl="+secret;
		return format;
	}
